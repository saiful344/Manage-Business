 <div class="twelve wide stretched column" >
    ...
    <div class="input-group mb-3 col-md-4" >
      <div class="input-group-prepend">
        <span class="input-group-text" id="basic-addon1">Box</span>
      </div>
      <input type="number" min="0" max="400" class="form-control barang" placeholder="Total Barang" aria-label="Username" aria-describedby="basic-addon1" data-toggle="tooltip" data-placement="top" title="Jumlah barang">
    </div>
     <div class="input-group mb-3 col-md-4" >
      <div class="input-group-prepend">
        <span class="input-group-text" id="basic-addon1">Target</span>
      </div>
      <input type="number" min="0" max="" class="form-control target" placeholder="Rp......" aria-label="Username" aria-describedby="basic-addon1" data-toggle="tooltip" data-placement="top" title="Target penjualan">
    </div>
    <div class="input-group mb-3 col-md-4" >
      <div class="input-group-prepend">
